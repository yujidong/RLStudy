r"""Build ch06_dqn_function_approximation.ipynb.

一次性脚本：构造 Ch06 笔记本（10 节内容）。运行后产物在 notebooks/。
"""
...
md("""## 6.5 Experience Replay：打破时序相关性
...
md("""## 6.6 Target Network：稳定"追逐移动目标"
...
code("""# Hard update vs Polyak update 对比
torch.manual_seed(0)
...
md("""## 6.7 DQN 完整算法 + CartPoleLite 训练
...
# =============================================================================
# 6.8 Double DQN & Dueling DQN
# =============================================================================

md("""## 6.8 Double DQN & Dueling DQN（兑现 Ch05 承诺）
...
code("""# 对比：标准 DQN vs Double DQN vs Dueling DQN
torch.manual_seed(0)
np.random.seed(0)
...
if __name__ == "__main__":
    ...
    _nb.write("ch06_dqn_function_approximation.ipynb")
